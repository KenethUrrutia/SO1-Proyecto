...
public class Monitor {
    ...
    public void consultar(int indexHora, String nombre, Color color) throws InterruptedException{
     ...
     public void reservar(int indexHora, String nombre, Color color) throws InterruptedException{
    ...
    public void cancelar(String nombre, Color color) throws InterruptedException{
